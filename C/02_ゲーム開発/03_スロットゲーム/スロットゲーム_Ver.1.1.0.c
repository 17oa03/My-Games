/*
【プログラム概要】
char型の一次元配列でスロットゲームを作る。
リールが回転しているような動作と、
ゲームクリア、ゲームオーバーの条件も作成する。
*/
...
/* ▼ ---------- ゲーム終了条件 ---------- ▼ */
	...
	while (end_flag == 0) {
		...
		srand((unsigned)time(NULL)); /* 実行時の時間を元にして、発生させる乱数の元を決めている。 */
