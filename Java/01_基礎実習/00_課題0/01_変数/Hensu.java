...
public class Hensu { // Hensu クラス、クラス名の頭文字は大文字、他は小文字、次の単語の頭文字は大文字
    public static void main(String[] args){ // main メソッド、コマンドライン引数は String クラス型の args 配列
        ...
        System.out.println("10 < 20 = " + b1); // 変数 b1 の true を出力
        System.out.println("10 > 20 = " + (10 > 20)); // ()内の演算結果は false

        char moji1 = 'a'; // char 型変数 moji1 に 1 文字('a')を格納
        int num1 = moji1; // int 型変数 num1 に 'a'(97) の文字コードを代入
        char moji2 = 'あ'; // char 型変数 moji2 に 1 文字('あ')を格納
        int num2 = moji2; // int 型変数 num2 に 'あ'(12354) の文字コードを代入
