...
public class Suugaku {
	public static void main(String[] args) {
		...
		double kisu = 2.0;
		double sisu = 3.0d; // 末尾に "D" または "d" で double 型リテラルと宣言
		System.out.println(kisu + " の " + sisu + " 乗 = " + Math.pow(kisu, sisu)); // pow(power) メソッドは引数 1(kisu) に引数 2(sisu) 回分を掛け合わせる

		double ransu = Math.random(); // Math クラスの random メソッドで 0.0 ～ 1.0 未満の範囲で double 型の乱数を取得
		System.out.println("0.0 から 1.0 未満の乱数 = " + ransu); // 出力
